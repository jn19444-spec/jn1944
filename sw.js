...
const CACHE_NAME = "gugu-shell-v13";
...
const PRECACHE_URLS = [
  "./",
  "./index.html",
  "./style.css?v=20260812a",
  "./app.js?v=20260812a",
  "./firebase-config.js?v=20260812a",
  "./manifest.json",
  "./icon-192.png",
  "./icon-512.png",
  "./hovercell/index.html",
  "./hovercell/css/editor.css",
  "./hovercell/js/app.js",
  "./hovercell/js/state.js",
  "./hovercell/js/generator.js",
  "./hovercell/js/preview.js",
];
